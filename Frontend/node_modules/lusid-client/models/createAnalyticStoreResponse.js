...
/**
 * Class representing a CreateAnalyticStoreResponse.
 */
class CreateAnalyticStoreResponse {
  /**
   * Create a CreateAnalyticStoreResponse.
   * @member {object} [error]
  ...
  /**
   * Defines the metadata of CreateAnalyticStoreResponse
   *
   * @returns {object} metadata of CreateAnalyticStoreResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'CreateAnalyticStoreResponse',
      type: {
        name: 'Composite',
        className: 'CreateAnalyticStoreResponse',
        modelProperties: {
          error: {
            required: false,
...
module.exports = CreateAnalyticStoreResponse;
