...
/**
 * Class representing a GetPortfolioVersionsResponse.
 */
class GetPortfolioVersionsResponse {
  /**
   * Create a GetPortfolioVersionsResponse.
   * @member {object} [error]
  ...
  /**
   * Defines the metadata of GetPortfolioVersionsResponse
   *
   * @returns {object} metadata of GetPortfolioVersionsResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetPortfolioVersionsResponse',
      type: {
        name: 'Composite',
        className: 'GetPortfolioVersionsResponse',
        modelProperties: {
          error: {
            required: false,
          ...
          items: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'EntityVersionResponseElementType',
                  type: {
                    name: 'Composite',
                    className: 'EntityVersionResponse'
                  }
              }
            }
          }
...
module.exports = GetPortfolioVersionsResponse;
