...
/**
 * Class representing a ListAnalyticStoresResponse.
 */
class ListAnalyticStoresResponse {
  /**
   * Create a ListAnalyticStoresResponse.
   * @member {object} [error]
  ...
  /**
   * Defines the metadata of ListAnalyticStoresResponse
   *
   * @returns {object} metadata of ListAnalyticStoresResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListAnalyticStoresResponse',
      type: {
        name: 'Composite',
        className: 'ListAnalyticStoresResponse',
        modelProperties: {
          error: {
            required: false,
          ...
          items: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'KeyValuePairStringDateTimeOffsetElementType',
                  type: {
                    name: 'Composite',
                    className: 'KeyValuePairStringDateTimeOffset'
                  }
              }
            }
          }
...
module.exports = ListAnalyticStoresResponse;
