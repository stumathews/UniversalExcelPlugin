...
/**
 * Class representing a IErrorResponse.
 */
class IErrorResponse {
  /**
   * Create a IErrorResponse.
   * @member {object} [error]
  ...
  /**
   * Defines the metadata of IErrorResponse
   *
   * @returns {object} metadata of IErrorResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'IErrorResponse',
      type: {
        name: 'Composite',
        className: 'IErrorResponse',
        modelProperties: {
          error: {
            required: false,
