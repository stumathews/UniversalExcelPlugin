...
/**
 * Class representing a TryAddClientSecuritiesResponse.
 */
class TryAddClientSecuritiesResponse {
  /**
   * Create a TryAddClientSecuritiesResponse.
   * @member {string} [self]
  ...
  /**
   * Defines the metadata of TryAddClientSecuritiesResponse
   *
   * @returns {object} metadata of TryAddClientSecuritiesResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'TryAddClientSecuritiesResponse',
      type: {
        name: 'Composite',
        className: 'TryAddClientSecuritiesResponse',
        modelProperties: {
          self: {
            required: false,
            serializedName: 'self',
          ...
          failedItems: {
            ...
            type: {
              ...
              value: {
                  required: false,
                  serializedName: 'ErrorMessageElementType',
                  type: {
                    name: 'Composite',
                    className: 'ErrorMessage'
                  }
...
module.exports = TryAddClientSecuritiesResponse;
