...
/**
 * Class representing a ListPropertyDataFormatResponse.
 */
class ListPropertyDataFormatResponse {
  /**
   * Create a ListPropertyDataFormatResponse.
   * @member {object} [error]
  ...
  /**
   * Defines the metadata of ListPropertyDataFormatResponse
   *
   * @returns {object} metadata of ListPropertyDataFormatResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListPropertyDataFormatResponse',
      type: {
        name: 'Composite',
        className: 'ListPropertyDataFormatResponse',
        modelProperties: {
          error: {
            required: false,
          ...
          items: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'PropertyDataFormatResponseElementType',
                  type: {
                    name: 'Composite',
                    className: 'PropertyDataFormatResponse'
                  }
              }
            }
          }
...
module.exports = ListPropertyDataFormatResponse;
