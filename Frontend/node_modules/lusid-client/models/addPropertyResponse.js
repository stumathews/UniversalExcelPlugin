...
/**
 * Class representing a AddPropertyResponse.
 */
class AddPropertyResponse {
  /**
   * Create a AddPropertyResponse.
   * @member {object} [error]
  ...
  /**
   * Defines the metadata of AddPropertyResponse
   *
   * @returns {object} metadata of AddPropertyResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'AddPropertyResponse',
      type: {
        name: 'Composite',
        className: 'AddPropertyResponse',
        modelProperties: {
          error: {
            required: false,
...
module.exports = AddPropertyResponse;
