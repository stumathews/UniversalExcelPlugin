...
/**
 * Class representing a GetPropertyScopesResponse.
 */
class GetPropertyScopesResponse {
  /**
   * Create a GetPropertyScopesResponse.
   * @member {object} [error]
  ...
  /**
   * Defines the metadata of GetPropertyScopesResponse
   *
   * @returns {object} metadata of GetPropertyScopesResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetPropertyScopesResponse',
      type: {
        name: 'Composite',
        className: 'GetPropertyScopesResponse',
        modelProperties: {
          error: {
            required: false,
          ...
          items: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'PropertyScopeResponseElementType',
                  type: {
                    name: 'Composite',
                    className: 'PropertyScopeResponse'
                  }
              }
            }
          }
...
module.exports = GetPropertyScopesResponse;
