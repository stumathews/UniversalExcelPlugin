...
/**
 * Class representing a LookupPortfolioRootResponse.
 */
class LookupPortfolioRootResponse {
  /**
   * Create a LookupPortfolioRootResponse.
   * @member {object} [error]
  ...
  /**
   * Defines the metadata of LookupPortfolioRootResponse
   *
   * @returns {object} metadata of LookupPortfolioRootResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LookupPortfolioRootResponse',
      type: {
        name: 'Composite',
        className: 'LookupPortfolioRootResponse',
        modelProperties: {
          error: {
            required: false,
...
module.exports = LookupPortfolioRootResponse;
