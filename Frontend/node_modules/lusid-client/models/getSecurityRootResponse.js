...
/**
 * Class representing a GetSecurityRootResponse.
 */
class GetSecurityRootResponse {
  /**
   * Create a GetSecurityRootResponse.
   * @member {object} [error]
  ...
  /**
   * Defines the metadata of GetSecurityRootResponse
   *
   * @returns {object} metadata of GetSecurityRootResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetSecurityRootResponse',
      type: {
        name: 'Composite',
        ...
        modelProperties: {
          ...
          aliases: {
            ...
            type: {
              name: 'Composite',
              className: 'GetSecurityRootResponseAliases'
            }
          }
        }
      }
...
module.exports = GetSecurityRootResponse;
