...
/**
 * Class representing a GetPortfolioPropertiesResponse.
 */
class GetPortfolioPropertiesResponse {
  /**
   * Create a GetPortfolioPropertiesResponse.
   * @member {object} [error]
  ...
  /**
   * Defines the metadata of GetPortfolioPropertiesResponse
   *
   * @returns {object} metadata of GetPortfolioPropertiesResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetPortfolioPropertiesResponse',
      type: {
        name: 'Composite',
        className: 'GetPortfolioPropertiesResponse',
        modelProperties: {
          error: {
            required: false,
          ...
          root: {
            ...
            type: {
              name: 'Composite',
              className: 'PortfolioRootResponse'
            }
          },
          self: {
            required: false,
          ...
          sourcePortfolioId: {
            required: false,
            serializedName: 'sourcePortfolioId',
            type: {
              name: 'String'
            }
          },
...
module.exports = GetPortfolioPropertiesResponse;
