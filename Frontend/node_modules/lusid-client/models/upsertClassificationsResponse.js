...
/**
 * Class representing a UpsertClassificationsResponse.
 */
class UpsertClassificationsResponse {
  /**
   * Create a UpsertClassificationsResponse.
   * @member {string} [self]
  ...
  /**
   * Defines the metadata of UpsertClassificationsResponse
   *
   * @returns {object} metadata of UpsertClassificationsResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'UpsertClassificationsResponse',
      type: {
        name: 'Composite',
        className: 'UpsertClassificationsResponse',
        modelProperties: {
          self: {
            required: false,
            serializedName: 'self',
...
module.exports = UpsertClassificationsResponse;
