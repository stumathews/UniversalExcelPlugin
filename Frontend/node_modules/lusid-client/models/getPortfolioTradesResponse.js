...
/**
 * Class representing a GetPortfolioTradesResponse.
 */
class GetPortfolioTradesResponse {
  /**
   * Create a GetPortfolioTradesResponse.
   * @member {object} [error]
  ...
  /**
   * Defines the metadata of GetPortfolioTradesResponse
   *
   * @returns {object} metadata of GetPortfolioTradesResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetPortfolioTradesResponse',
      type: {
        name: 'Composite',
        className: 'GetPortfolioTradesResponse',
        modelProperties: {
          error: {
            required: false,
          ...
          items: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'TradeElementType',
                  type: {
                    name: 'Composite',
                    className: 'Trade'
                  }
...
module.exports = GetPortfolioTradesResponse;
