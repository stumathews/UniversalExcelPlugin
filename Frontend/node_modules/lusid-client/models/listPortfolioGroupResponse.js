...
/**
 * Class representing a ListPortfolioGroupResponse.
 */
class ListPortfolioGroupResponse {
  /**
   * Create a ListPortfolioGroupResponse.
   * @member {object} [error]
  ...
  /**
   * Defines the metadata of ListPortfolioGroupResponse
   *
   * @returns {object} metadata of ListPortfolioGroupResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListPortfolioGroupResponse',
      type: {
        name: 'Composite',
        className: 'ListPortfolioGroupResponse',
        modelProperties: {
          error: {
            required: false,
          ...
          items: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'GroupDefinitionResponseElementType',
                  type: {
                    name: 'Composite',
...
module.exports = ListPortfolioGroupResponse;
