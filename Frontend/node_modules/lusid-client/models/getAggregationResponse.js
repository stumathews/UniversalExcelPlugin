...
/**
 * Class representing a GetAggregationResponse.
 */
class GetAggregationResponse {
  /**
   * Create a GetAggregationResponse.
   * @member {string} [self]
  ...
  /**
   * Defines the metadata of GetAggregationResponse
   *
   * @returns {object} metadata of GetAggregationResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetAggregationResponse',
      type: {
        name: 'Composite',
        className: 'GetAggregationResponse',
        modelProperties: {
          self: {
            required: false,
            serializedName: 'self',
          ...
          data: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'IDataRecordElementType',
                  type: {
                    name: 'Composite',
                    className: 'IDataRecord'
                  }
              }
            }
          },
...
module.exports = GetAggregationResponse;
