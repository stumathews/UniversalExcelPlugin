...
/**
 * Class representing a GetAnalyticStoreResponse.
 */
class GetAnalyticStoreResponse {
  /**
   * Create a GetAnalyticStoreResponse.
   * @member {object} [error]
  ...
  /**
   * Defines the metadata of GetAnalyticStoreResponse
   *
   * @returns {object} metadata of GetAnalyticStoreResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetAnalyticStoreResponse',
      type: {
        name: 'Composite',
        className: 'GetAnalyticStoreResponse',
        modelProperties: {
          error: {
            required: false,
...
module.exports = GetAnalyticStoreResponse;
