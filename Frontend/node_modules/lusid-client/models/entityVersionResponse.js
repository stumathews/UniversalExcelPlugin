...
/**
 * Class representing a EntityVersionResponse.
 */
class EntityVersionResponse {
  /**
   * Create a EntityVersionResponse.
  ...
  /**
   * Defines the metadata of EntityVersionResponse
   *
   * @returns {object} metadata of EntityVersionResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'EntityVersionResponse',
      type: {
        name: 'Composite',
...
module.exports = EntityVersionResponse;
