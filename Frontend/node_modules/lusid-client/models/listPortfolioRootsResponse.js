...
/**
 * Class representing a ListPortfolioRootsResponse.
 */
class ListPortfolioRootsResponse {
  /**
   * Create a ListPortfolioRootsResponse.
   * @member {string} [self]
  ...
  /**
   * Defines the metadata of ListPortfolioRootsResponse
   *
   * @returns {object} metadata of ListPortfolioRootsResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ListPortfolioRootsResponse',
      type: {
        name: 'Composite',
        className: 'ListPortfolioRootsResponse',
        modelProperties: {
          self: {
            required: false,
            serializedName: 'self',
          ...
          items: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'GetPortfolioRootResponseElementType',
                  type: {
                    name: 'Composite',
...
module.exports = ListPortfolioRootsResponse;
