...
/**
 * Class representing a GetPortfolioRootResponse.
 */
class GetPortfolioRootResponse {
  /**
   * Create a GetPortfolioRootResponse.
   * @member {object} [error]
   ...
   * @member {string} [schema] Link to retrieve the schema for the current
   * entity
  ...
  /**
   * Defines the metadata of GetPortfolioRootResponse
   *
   * @returns {object} metadata of GetPortfolioRootResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetPortfolioRootResponse',
      type: {
        name: 'Composite',
        className: 'GetPortfolioRootResponse',
        modelProperties: {
          error: {
            required: false,
          ...
          properties: {
            ...
            type: {
              name: 'Composite',
              className: 'PortfolioPropertiesResponse'
            }
          },
          details: {
            required: false,
            ...
            type: {
              name: 'Composite',
              className: 'PortfolioDetailsResponse'
            }
          },
          self: {
            required: false,
          ...
          referencePortfolioId: {
            required: false,
            serializedName: 'referencePortfolioId',
            type: {
              name: 'String'
            }
          },
...
module.exports = GetPortfolioRootResponse;
