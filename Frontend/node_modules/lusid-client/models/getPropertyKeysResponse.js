...
/**
 * Class representing a GetPropertyKeysResponse.
 */
class GetPropertyKeysResponse {
  /**
   * Create a GetPropertyKeysResponse.
   * @member {object} [error]
  ...
  /**
   * Defines the metadata of GetPropertyKeysResponse
   *
   * @returns {object} metadata of GetPropertyKeysResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'GetPropertyKeysResponse',
      type: {
        name: 'Composite',
        className: 'GetPropertyKeysResponse',
        modelProperties: {
          error: {
            required: false,
          ...
          items: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'PropertyDefinitionKeyResponseElementType',
                  type: {
                    name: 'Composite',
                    className: 'PropertyDefinitionKeyResponse'
                  }
              }
            }
          }
...
module.exports = GetPropertyKeysResponse;
