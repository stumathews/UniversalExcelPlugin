...
/**
 * Class representing a LookupSecuritiesFromCodesResponse.
 */
class LookupSecuritiesFromCodesResponse {
  /**
   * Create a LookupSecuritiesFromCodesResponse.
   * @member {string} [self]
  ...
  /**
   * Defines the metadata of LookupSecuritiesFromCodesResponse
   *
   * @returns {object} metadata of LookupSecuritiesFromCodesResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'LookupSecuritiesFromCodesResponse',
      type: {
        name: 'Composite',
        className: 'LookupSecuritiesFromCodesResponse',
        modelProperties: {
          self: {
            required: false,
            serializedName: 'self',
          ...
          items: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'GetSecurityRootResponseElementType',
                  type: {
                    name: 'Composite',
                    className: 'GetSecurityRootResponse'
                  }
              }
            }
          },
...
module.exports = LookupSecuritiesFromCodesResponse;
