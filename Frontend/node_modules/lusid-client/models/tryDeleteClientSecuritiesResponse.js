...
/**
 * Class representing a TryDeleteClientSecuritiesResponse.
 */
class TryDeleteClientSecuritiesResponse {
  /**
   * Create a TryDeleteClientSecuritiesResponse.
   * @member {string} [self]
  ...
  /**
   * Defines the metadata of TryDeleteClientSecuritiesResponse
   *
   * @returns {object} metadata of TryDeleteClientSecuritiesResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'TryDeleteClientSecuritiesResponse',
      type: {
        name: 'Composite',
        className: 'TryDeleteClientSecuritiesResponse',
        modelProperties: {
          self: {
            required: false,
            serializedName: 'self',
          ...
          failed: {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'SecurityUidElementType',
                  type: {
                    name: 'Composite',
                    className: 'SecurityUid'
                  }
              }
            }
          },
...
module.exports = TryDeleteClientSecuritiesResponse;
