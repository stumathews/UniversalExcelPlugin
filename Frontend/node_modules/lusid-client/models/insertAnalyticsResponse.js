...
/**
 * Class representing a InsertAnalyticsResponse.
 */
class InsertAnalyticsResponse {
  /**
   * Create a InsertAnalyticsResponse.
   * @member {object} [error]
  ...
  /**
   * Defines the metadata of InsertAnalyticsResponse
   *
   * @returns {object} metadata of InsertAnalyticsResponse
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'InsertAnalyticsResponse',
      type: {
        name: 'Composite',
        className: 'InsertAnalyticsResponse',
        modelProperties: {
          error: {
            required: false,
...
module.exports = InsertAnalyticsResponse;
